        ...
        try:
            ...
            if AutoPairingEventType.DEVICE_PAIRIED ==event_type:   
                ...
                if len(device_pairing_info) > 0:
                    ...
                    device_paired_date= device_pairing_info.iloc[0]["Device_Pairing_Date"]
                    device_paired_by= device_pairing_info.iloc[0]["Device_Paired_By"]
                    ...
                    add_new_pairing_info_in_history(db=db, unit_nr=unit_nr, asset_id = asset_id, 
                        device_imei=device_number, device_type=device_type, pairing_date=device_paired_date, device_unpairing_date= pairing_date, device_paired_by= device_paired_by)
